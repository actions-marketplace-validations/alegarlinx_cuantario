...
INFO_URI = "https://github.com/alegarlinx/pqc-radar"
...
def build_sarif(findings: list[Finding]) -> dict:
    ...
    for f in findings:
        ...
        results.append({
            ...
            "locations": [location],
            "partialFingerprints": {"pqcRadar/v1": _fingerprint(f)},
    ...
    return {
        ...
        "version": "2.1.0",
        "runs": [{
            "tool": {"driver": {"name": "PQC-Radar", "version": __version__, "semanticVersion": __version__,
